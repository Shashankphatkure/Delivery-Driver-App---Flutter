                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: Text(
                                                '# Order Id : ${columnOrderRow.id.toString()}',
                                                style:
                                        ...
                                        Text(
                                          'Date : ${columnOrderRow.amount?.toString()}',
                                        ...
                                        Padding(
                                          padding:
                                              const EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 4.0, 0.0, 0.0),
                                          child: Text(
                                            'Customer : ${cardCustomersRow?.name}',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Readex Pro',
                                        ...
                                        Text(
                                          'Amount Earned : ${columnOrderRow.amount?.toString()}',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Readex Pro',
