...
class FruitAffairDeliverySupabaseUser extends BaseAuthUser {
  FruitAffairDeliverySupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> fruitAffairDeliverySupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = FruitAffairDeliverySupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
